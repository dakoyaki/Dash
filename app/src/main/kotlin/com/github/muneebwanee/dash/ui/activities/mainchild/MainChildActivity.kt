package com.github.dakoyaki.dash.ui.activities.mainchild
...
import com.github.dakoyaki.dash.data.model.ChildPhoto
import com.github.dakoyaki.dash.data.rxFirebase.InterfaceFirebase
import com.github.dakoyaki.dash.ui.activities.base.BaseActivity
import com.github.dakoyaki.dash.utils.Consts.CHILD_PERMISSION
import com.github.dakoyaki.dash.utils.Consts.CHILD_SHOW_APP
import com.github.dakoyaki.dash.utils.Consts.DATA
import com.github.dakoyaki.dash.utils.Consts.PARAMS
import com.github.dakoyaki.dash.utils.Consts.PHOTO
import com.github.dakoyaki.dash.utils.ConstFun.isNotificationServiceRunning
import com.github.dakoyaki.dash.utils.hiddenCameraServiceUtils.HiddenCameraUtils.canOverDrawOtherApps
import com.github.dakoyaki.dash.utils.hiddenCameraServiceUtils.HiddenCameraUtils.openDrawOverPermissionSetting
import com.github.dakoyaki.dash.utils.hiddenCameraServiceUtils.config.CameraFacing
import com.github.dakoyaki.dash.utils.ConstFun.openUseAccessSettings
import com.github.dakoyaki.dash.utils.checkForegroundApp.CheckPermission.hasUsageStatsPermission
import com.github.dakoyaki.dash.data.model.ChildRecording
import com.github.dakoyaki.dash.utils.Consts.RECORDING
import javax.inject.Inject
import com.google.firebase.database.DatabaseReference
import android.widget.RelativeLayout
import android.widget.Switch
import cn.pedant.SweetAlert.SweetAlertDialog
import com.github.dakoyaki.dash.data.preference.DataSharePreference.childSelected
import com.github.dakoyaki.dash.services.accessibilityData.AccessibilityDataService
import com.github.dakoyaki.dash.utils.ConstFun.isAddWhitelist
import com.github.dakoyaki.dash.utils.ConstFun.isAndroidM
import com.github.dakoyaki.dash.utils.ConstFun.openAccessibilitySettings
import com.github.dakoyaki.dash.utils.ConstFun.openNotificationListenerSettings
import com.github.dakoyaki.dash.utils.ConstFun.openWhitelistSettings
import com.github.dakoyaki.dash.utils.ConstFun.permissionRoot
import com.github.dakoyaki.dash.utils.ConstFun.showApp
import com.github.dakoyaki.dash.utils.Consts
import com.github.dakoyaki.dash.utils.Consts.CHILD_NAME
import com.github.dakoyaki.dash.utils.Consts.COMMAND_ADD_WHITELIST
import com.github.dakoyaki.dash.utils.Consts.COMMAND_ENABLE_ACCESSIBILITY
import com.github.dakoyaki.dash.utils.Consts.COMMAND_ENABLE_ACCESSIBILITY_1
import com.github.dakoyaki.dash.utils.Consts.COMMAND_ENABLE_NOTIFICATION_LISTENER
import com.github.dakoyaki.dash.utils.Consts.COMMAND_GRANT_PERMISSION
import com.github.dakoyaki.dash.utils.Consts.DEVICE_NAME
import com.github.dakoyaki.dash.utils.Consts.INTERVAL
import com.github.dakoyaki.dash.utils.Consts.PERMISSION_USAGE_STATS
import com.github.dakoyaki.dash.utils.Consts.TIMER
import com.github.dakoyaki.dash.utils.async.AsyncTaskRunCommand
import com.github.dakoyaki.dash.utils.checkForegroundApp.CheckPermission.getModeManager
